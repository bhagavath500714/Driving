      ...
      renderRewards() {
          return (
            <Card shadow style={{ paddingVertical: theme.sizes.base * 2 }}>
                ...
                <Block center>
                  <Text title spacing={1} style={{marginVertical: 8}}>Driving Score</Text>
                  <Text>
                    <Text>
                ...
                <Block row>
                    <Block center flex={0.8}>
                        ...
                        <Text body spacing={0.7}>Trip</Text>
                    </Block>
      ...
      renderChallenges() {
        return (
          <Block>
            ...
            <Block middle>
                <Text size={theme.sizes.base} spacing={0.4} medium white>Hit zero pedestrains</Text>
